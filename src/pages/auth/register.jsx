...
export default function Register(){
    const [Users, setUsers] = useState({ username: 'username', password: 'password', confirm_password: 'confirm_password', is_admin: true })
            ...
            <>
                <div className="bg-no-repeat bg-auto" style={{backgroundImage:`url("/img/login.png")`}}>
                    <div className="flex">
                        ...
                        <div className="mt-12"></div>
                        <input type="password" onChange={onChangeInput} name="confirm_password" id="confirm_password" placeholder="Confirm Password" class="container mx-auto rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                        <div className="mt-12"></div>
                        <button onClick={daftar} ref={refLogin} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-20 border border-blue-700 rounded">Sign up</button>
                        <br />
                        <div className="mt-5"></div>
                        <button className="bg-white-500 font-bold py-2 px-8 border rounded"><FontAwesomeIcon icon={faGoogle}/> Sign up with google</button>
                        </div>
                        </div>
                </div>
                <Footer />
